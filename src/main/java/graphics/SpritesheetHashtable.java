...
public class SpritesheetHashtable {
	...
	public static void registerSpritesheets() throws Exception { //registers all spritesheets by id
		registerSpritesheet(1, new Spritesheet("/tiles.png", 0));
		registerSpritesheet(2, new Spritesheet("/characters.png", 0));
		registerSpritesheet(3, new Spritesheet("/indoor.png", 0));
	}
